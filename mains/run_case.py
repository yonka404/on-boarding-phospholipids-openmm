...
def main(argv: list[str] | None = None) -> None:
    parser = argparse.ArgumentParser(description="Run one CHARMM-GUI membrane case with OpenMM")
    parser.add_argument("--system-root", required=True, help="Path to the CHARMM-GUI folder")
